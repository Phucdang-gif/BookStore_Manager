...
// contentPanel.add(createComboBox(new String[] { "Tất cả", "NXB Kim Đồng", "NXB
// Trẻ", "Nhã Nam" }));
// contentPanel.add(Box.createVerticalStrut(16));

// // Danh mục
// contentPanel.add(createSectionLabel("Danh mục"));
// contentPanel.add(createComboBox(new String[] { "Tất cả", "Văn học", "Kinh
// tế", "Thiếu nhi" }));
// contentPanel.add(Box.createVerticalStrut(16));

// // Tác giả
// contentPanel.add(createSectionLabel("Tác giả"));
// contentPanel.add(createComboBox(new String[] { "Tất cả", "Nguyễn Nhật Ánh",
// "J.K. Rowling" }));
// contentPanel.add(Box.createVerticalStrut(16));

// // Ngôn ngữ
// contentPanel.add(createSectionLabel("Ngôn ngữ"));
// contentPanel.add(createComboBox(new String[] { "Tất cả", "Tiếng Việt", "Tiếng
// Anh" }));
// contentPanel.add(Box.createVerticalStrut(16));
...
// String minStr = min >= 1000 ? String.format("%,d", min) :
// String.valueOf(min);
// String maxStr = max >= 1000 ? String.format("%,d", max) :
// String.valueOf(max);
...
// private JButton createButton(String text, Color bg, Color fg, boolean
// isPrimary) {
